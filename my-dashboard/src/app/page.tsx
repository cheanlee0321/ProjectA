    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-6 md:p-12 lg:p-24 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          {/* Common Websites Card */}
          <Link href="/common-sites" className="group">
            <div className="h-full relative p-8 md:p-12 rounded-3xl bg-foreground/5 backdrop-blur-xl border border-foreground/10 overflow-hidden transition-all duration-500 ease-out hover:-translate-y-2 hover:bg-foreground/10 hover:border-foreground/20 hover:shadow-[0_20px_40px_-15px_rgba(20,184,166,0.3)]">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  ...
                  <h2 className="text-3xl font-bold text-foreground mb-4">常用網站</h2>
                  <p className="text-foreground/60 text-lg leading-relaxed">
          ...
          {/* Investment Quotes Card */}
          <Link href="/quotes" className="group">
            <div className="h-full relative p-8 md:p-12 rounded-3xl bg-foreground/5 backdrop-blur-xl border border-foreground/10 overflow-hidden transition-all duration-500 ease-out hover:-translate-y-2 hover:bg-foreground/10 hover:border-foreground/20 hover:shadow-[0_20px_40px_-15px_rgba(249,115,22,0.3)]">
              {/* Inner Gradient */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="w-16 h-16 rounded-2xl bg-orange-500/20 flex items-center justify-center mb-8 border border-orange-500/30 group-hover:scale-110 transition-transform duration-500">
                    <span className="text-3xl">📜</span>
                  </div>
                  <h2 className="text-3xl font-bold text-foreground mb-4">投資金句</h2>
                  <p className="text-foreground/60 text-lg leading-relaxed">
                    收錄投資大師的經典語錄，幫助您在市場喧囂中保持冷靜與理性。
                  </p>
                </div>
                <div className="mt-8 flex items-center text-orange-500 font-medium group-hover:text-orange-400 transition-colors">
                  <span>閱讀金句</span>
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
          ...
          <Link href="/strategy" className="group">
            <div className="h-full relative p-8 md:p-12 rounded-3xl bg-foreground/5 backdrop-blur-xl border border-foreground/10 overflow-hidden transition-all duration-500 ease-out hover:-translate-y-2 hover:bg-foreground/10 hover:border-foreground/20 hover:shadow-[0_20px_40px_-15px_rgba(139,92,246,0.3)]">
              {/* Inner Gradient */}
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="w-16 h-16 rounded-2xl bg-violet-500/20 flex items-center justify-center mb-8 border border-violet-500/30 group-hover:scale-110 transition-transform duration-500">
                    <span className="text-3xl">🎯</span>
                  </div>
                  <h2 className="text-3xl font-bold text-foreground mb-4">投資策略</h2>
                  <p className="text-foreground/60 text-lg leading-relaxed">
                    深入剖析各類投資策略與資產配置邏輯，打造專屬您的穩健獲利方程式。
                  </p>
                </div>
                <div className="mt-8 flex items-center text-violet-500 font-medium group-hover:text-violet-400 transition-colors">
                  <span>查看策略</span>
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
